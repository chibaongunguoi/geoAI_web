...
\input{tables/bang_tong_hop_chi_phi.tex}

Bảng tổng hợp dự toán:
\input{tables/bang_tong_hop_du_toan.tex}
...
\input{tables/bang_danh_sach_tac_nhan.tex}
...
\input{tables/bang_taw.tex}
\cleardoublepage
\textbf{- Bảng tính điểm các trường hợp sử dụng (use case):}
\input{tables/bang_tbf.tex}
\cleardoublepage
\textbf{- Bảng hệ số phức tạp kỹ thuật – công nghệ (TCF):}
\input{tables/bang_tcf.tex}
\cleardoublepage

\textbf{- Bảng tính toán hệ số tác động môi trường, nhóm làm việc (ECF):}
\input{tables/bang_ecf.tex}
\cleardoublepage

\textbf{- Bảng tính lương nhân công:}
\input{tables/bang_luong_nhan_cong.tex}
\cleardoublepage

\textbf{- Bảng tính toán chi phí trực tiếp xây dựng phần mềm nội bộ:}
\input{tables/bang_chi_phi_truc_tiep.tex}
\cleardoublepage

\textbf{- Bảng chi phí kiểm thử phần mềm:}
\input{tables/bang_chi_phi_kiem_thu_pm.tex}
\vspace{0.3cm}

\textbf{- Bảng chi phí kiểm thử an toàn an ninh thông tin:}
\input{tables/bang_chi_phi_kiem_thu_attt.tex}
\cleardoublepage
\textbf{Tổng dự toán}
Bảng tổng hợp chi phí phần mềm nội bộ:
\input{tables/bang_tong_hop_chi_phi.tex}
...
\end{itemize}
\cleardoublepage
\section*{PHỤ LỤC II - YÊU CẦU HẠ TẦNG TRIỂN KHAI}
\addcontentsline{toc}{section}{PHỤ LỤC II - YÊU CẦU HẠ TẦNG TRIỂN KHAI}
\input{tables/bang_phu_luc_3.tex}
