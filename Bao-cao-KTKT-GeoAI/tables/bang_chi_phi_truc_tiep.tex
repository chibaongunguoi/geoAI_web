...
\textbf{II} & \textbf{Nội suy thời gian lao động (P)} & Giờ công/điểm UC & P & 17 & Nội suy từ PL VII (17-28 giờ) \\ \hline
...
\textbf{V} & \textbf{Chi phí trực tiếp PM nội bộ (G)} & $G = 1,4 \times E \times P \times H$ & G & 188.976.132 & đồng \\ \hline
\end{xltabular}