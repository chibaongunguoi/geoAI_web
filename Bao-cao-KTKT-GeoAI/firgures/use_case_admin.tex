\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
    ...
    \node[usecase] (uc1) at (-6, 3.7) {Quản lý người dùng\\và phân quyền};
    \node[usecase] (uc2) at (-6, 1.7) {Quản lý danh mục\\loại tài sản};
    \node[usecase] (uc3) at (-6, -0.3) {Quản lý danh mục\\khu vực địa lý};
    \node[usecase] (uc4) at (-6, -2.3) {Cấu hình hệ thống\\và bản đồ};
