...
import { PropertiesLlmService } from "./properties.llm.service";
import { PropertiesScoringService } from "./properties.scoring.service";

@Module({
  imports: [AuthModule, PrismaModule],
  controllers: [PropertiesController],
  providers: [PropertiesCrudService, PropertiesSearchService, PropertiesSpatialService, PropertiesImportService, PropertiesLlmService, PropertiesScoringService],
  exports: [PropertiesCrudService, PropertiesSearchService, PropertiesSpatialService, PropertiesImportService, PropertiesLlmService, PropertiesScoringService]
})
